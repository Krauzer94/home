...
void main() {
	...
	modelPosition. w = 1.0 ;
	gl_Position . x = dot4 ( modelPosition , _va_[7 /* rpMVPmatrixX */] ) ;
	gl_Position . y = dot4 ( modelPosition , _va_[8 /* rpMVPmatrixY */] ) ;
	gl_Position . z = dot4 ( modelPosition , _va_[9 /* rpMVPmatrixZ */] ) ;
	gl_Position . w = dot4 ( modelPosition , _va_[10 /* rpMVPmatrixW */] ) ;
